...
//go:generate mockgen --destination=./mocks/databaseHelper.go github.com/pienaahj/databases DatabaseHelper
type DatabaseHelper interface {
	Collection(name string) CollectionHelper
	Client() ClientHelper
}

//go:generate mockgen --destination=./mocks/collectionHelper.go github.com/pienaahj/databases CollectionHelper
...
//go:generate mockgen --destination=./mocks/singleResultHelper.go github.com/pienaahj/databases SingleResultHelper
type SingleResultHelper interface {
	Decode(v interface{}) error
}

//go:generate mockgen --destination=./mocks/clientHelper.go github.com/pienaahj/databases ClientHelper
